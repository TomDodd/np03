// NP03.cpp : Defines the entry point for the console application.
//
/*
  C verion of NP03 detector simulation program. (Visual Studio C++ version)
  To compile: F7 for 1st build <Ctrl>+<Alt>+F7 for rebuild
  To run:     np03 inputfile outputfile
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	strncpy(infile ,argn[1],sizeof(infile));
	strncpy(outfile,argn[2],sizeof(outfile));
